...
export const UserProfile: React.FC = () => {
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <button
        onClick={logout}
        className="ml-2 rounded-md border border-gray-300 bg-white px-3 py-1 text-sm text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500"
      >
        Logout
      </button>
    </div>
